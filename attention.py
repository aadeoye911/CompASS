...
class AttentionStore():
    ...
    def resize_attention_map(self, attn_map, scale_factor, downsample_mode="bilinear", upsample_mode="bilinear"):
        ...
        if scale_factor > 1:
            ...
            resized_map = F.interpolate(attn_map, size=target_res, mode=upsample_mode, align_corners=True)
        ...
        # Handle downsampling
            ...
            if downsample_mode == "max":
                ...
                resized_map = F.interpolate(attn_map, size=target_res, mode=downsample_mode, align_corners=True)
            else:
